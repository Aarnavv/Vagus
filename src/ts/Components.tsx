...
//   switch (id) {
//     case "master-drop":
//       if (document.getElementById("master-drop-hide").style.display != "none") {
//         document.getElementById("master-drop-hide").style.display = "none";
//         document.getElementById(id).style.transform = "rotate(-90deg)";
//       }
//       else {
//         document.getElementById("master-drop-hide").style.display = "block";
//         document.getElementById(id).style.transform = "rotate(0deg)";
//       }
//       break;
//     case "master-control-drop":
//       if (document.getElementById("master-control-drop-hide").style.display != "none") {
//         document.getElementById("master-control-drop-hide").style.display = "none";
//         document.getElementById(id).style.transform = "rotate(-90deg)";
//       }
//       else {
//       document.getElementById("master-control-drop-hide").style.display = "block";
//       document.getElementById(id).style.transform = "rotate(0deg)";
//       }
//       break;
//     case "advanced-control-drop":
//       if (document.getElementById("advanced-control-drop-hide").style.display != "none") {
//       document.getElementById("advanced-control-drop-hide").style.display = "none";
//       document.getElementById(id).style.transform = "rotate(-90deg)";
//       }
//       else {
//       document.getElementById("advanced-control-drop-hide").style.display = "block";
//       document.getElementById(id).style.transform = "rotate(0deg)";
//       }
//       break;
//     case "algorithm-drop":
//       if (document.getElementById("algorithm-drop-hide").style.display != "none") {
//       document.getElementById("algorithm-drop-hide").style.display = "none";
//       document.getElementById(id).style.transform = "rotate(-90deg)";
//       }
//       break;
//     case "add-node-drop":
//       document.getElementById("add-node-drop-hide").style.display = "none";
//       document.getElementById(id).style.transform = "rotate(-90deg)";
//       break;
//     case "mazes-drop":
//       document.getElementById("mazes-drop-hide").style.display = "none";
//       document.getElementById(id).style.transform = "rotate(-90deg)";
//       break;
//     case "speed-drop":
//       document.getElementById("speed-drop-hide").style.display = "none";
//       document.getElementById(id).style.transform = "rotate(-90deg)";
//       break;
//   }
// }
