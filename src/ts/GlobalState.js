...
export { currentAddableNode, changeAddableNode, currentAlgorithm, changeAlgorithm, currentMaze, changeMaze, currentSpeed, changeSpeed, SOLIDRED, LIGHTRED, BLUE, GREEN, YELLOW, FILEBG, FILEBGSELECTED, FILEBORDER, GRAPH, };
