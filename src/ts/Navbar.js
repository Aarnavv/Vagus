                    ...
                    React.createElement("div", { className: "advanced-cp-border" },
                        React.createElement(FolderComponent, { colorOfFolder: SOLID_RED, text: "advanced-control-panel", divClassName: "folder advanced-cp-comp", arrowID: "advanced-cp-arrow" },
                            React.createElement("div", { className: "advanced-cp-border" },
                                ...
                                React.createElement(FolderComponent, { colorOfFolder: BLUE, text: "addableNodes", divClassName: "folder advanced-cp-comp", arrowID: "addable-arrow" },
                                    React.createElement("div", { className: "folder-drop-inner" },
                                ...
                                React.createElement(FolderComponent, { colorOfFolder: YELLOW, text: "speeds", divClassName: "folder advanced-cp-comp", arrowID: "speeds-arrow" },
                                    React.createElement("div", { className: "folder-drop-inner" },
