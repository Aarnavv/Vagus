                            ...
                            React.createElement("div", { className: "advanced-cp-border" },
                                ...
                                React.createElement(FolderComponent, { colorOfFolder: cssConstants.GREEN, text: "mazes [Works! somewhat...]", divClassName: "folder advanced-cp-comp", arrowID: "mazes-arrow" },
                                    React.createElement("div", { className: "folder-drop-inner" },
                                        ...
                                        React.createElement(BATFile, { divClassName: "file bat-file", pClassName: "maze-name file-name", text: "generateWeightedRidges.bat", divID: "bat-5" }),
                                        React.createElement(BATFile, { divClassName: "file bat-file", pClassName: "maze-name file-name", text: "generateWeightedRandomMaze.bat", divID: "bat-6" }),
                                        React.createElement(BATFile, { divClassName: "file bat-file", pClassName: "maze-name file-name", text: "generateBlockedRandomMaze.bat", divID: "bat-7" }))),
