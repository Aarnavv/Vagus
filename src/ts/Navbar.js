                            ...
                            React.createElement("div", { className: "advanced-cp-border" },
                                ...
                                React.createElement(FolderComponent, { colorOfFolder: cssConstants.GREEN, text: "mazes", divClassName: "folder advanced-cp-comp", arrowID: "mazes-arrow" },
                                    React.createElement("div", { className: "folder-drop-inner" },
                                        ...
                                        React.createElement(BATFile, { divClassName: "file bat-file", pClassName: "maze-name file-name", text: "generateRidges.bat", divID: "bat-4" }),
                                        React.createElement(BATFile, { divClassName: "file bat-file", pClassName: "maze-name file-name", text: "generateWeightedRandomMaze.bat", divID: "bat-5" }),
                                        React.createElement(BATFile, { divClassName: "file bat-file", pClassName: "maze-name file-name", text: "generateBlockedRandomMaze.bat", divID: "bat-6" }))),
