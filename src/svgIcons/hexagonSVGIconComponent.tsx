...
export function HexIcon(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg className="icon" xmlns="http://www.w3.org/2000/svg" width="40" height="41" viewBox="0 0 34 30"
             fill="currentColor" {...props}>
            <path id="Polygon 522" d="M26.763 27.7849L32.9536 17.0625C33.6904 15.7862 33.6904 14.2138 32.9536 12.9375L26.763
